...
param_path = os.path.normpath(
    os.path.join(script_dir, "../../modelparameter/structural/plant/droopy_telephone_pole.xml")
)
...
# Collect root node coordinates (cm) and print table (same axes as side-view plot)
root_rows = []
...
print("\n2D root coordinates (cm) — x and depth (z):\n")
with pd.option_context("display.max_rows", None, "display.width", 100, "display.float_format", "{:.4f}".format):
