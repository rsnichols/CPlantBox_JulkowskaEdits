...
params.set_kx_const(kx_mp, subType=1)
params.set_kx_const(kx_mm, subType=2)
params.set_kx_const(kx_mt, subType=3)
params.set_kx_const(kx_lp, subType=4)
params.set_kx_const(kx_lm, subType=5)
params.set_kx_const(kx_lt, subType=6)
params.set_kr_const(kr_mp, subType=1)
params.set_kr_const(kr_mm, subType=2)
params.set_kr_const(kr_mt, subType=3)
params.set_kr_const(kr_lp, subType=4)
params.set_kr_const(kr_lm, subType=5)
params.set_kr_const(kr_lt, subType=6)
